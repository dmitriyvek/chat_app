...
const getNewAccessToken = () => {
  return (dispatch) => {
    ...
    axios
      .post(`${process.env.APP_DOMAIN_NAME}/api-auth/login/refresh/`, {
...
export const authLogin = (username, password) => {
  return (dispatch) => {
    dispatch(authStart());
    axios
      .post(`${process.env.APP_DOMAIN_NAME}/api-auth/login/`, {
        username: username,
        password: password,
      })
...
export const authSignup = (username, password) => {
  return (dispatch) => {
    dispatch(authStart());
    axios
      .post(`${process.env.APP_DOMAIN_NAME}/api-auth/signup/`, {
        username: username,
        password: password,
      })
      .then((response) => dispatch(onLoginResponse(response, username)))
